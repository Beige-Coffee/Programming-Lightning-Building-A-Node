...
Okay, now that we've reviewed many of the decisions we'll have to make when creating a new channel, let's go ahead and do it ourselves!

Head over to `src/commands.rs`. In this file, you should find the following function:
...
pub fn open_channel(
  ...
  // call channel_manager.create_channel()
  // if Ok, println!("EVENT: initiated channel with peer {}. ", peer_pubkey);
    // return Ok(())
  // if Err(e), println!("ERROR: failed to open channel: {:?}", e);
    // return Err(())
