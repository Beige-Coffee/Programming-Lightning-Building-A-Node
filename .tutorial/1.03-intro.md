...
# Key Takeaways
As I mentioned at the beggining of this section, you're not going to become a Rust pro overnight! However, you don't need to be a Rust pro to complete this workshop. Instead, if you're able to learn a little bit of Rust syntax (declaring variables, writing functions, implementing methods for Structs) and build an intuition for Rust's approach to memory management (ownership model), then you should be in a better place to take this workshop!