...
This one is a little tricky, since we have not discussed anchor outputs yet. We'll learn about anchor outputs later, but, for now, take a look at the below commitment transaction. **If Alice has to force-close her channel with Bob by publishing this transaction, would she be able to increase the fees later?**
